...
const T={tx:34,ty:36,sx:0.84,sy:0.84}
...
const stars=[
[0,0.13,0.62],[1,0.35,0.58],[2,0.42,0.74],[3,0.46,0.48],[4,0.51,0.42],
[5,0.56,0.34],[6,0.62,0.24],[7,0.62,0.14],[8,0.54,0.06],[9,0.44,0.18]]
const lines=[[0,1],[1,2],[1,3],[3,4],[4,5],[5,6],[6,7],[7,8],[8,9]]
